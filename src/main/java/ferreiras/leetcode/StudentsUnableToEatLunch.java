...
by numbers 0 and 1 respectively. All students stand in a queue.
...
public class StudentsUnableToEatLunch {
  ...
  public static void main(String[] args) {
    ...
    int response = countStudent(students, sandwiches);
  ...
  public static int countStudents(int[] students, int[] sandwiches) {
    ...
    int numberOfSandwiches = sandwiches.length;
    int sizeOfStudentsQueue = students.length;

    if (sizeOfStudentsQueue != numberOfSandwiches) return -1;
    for (int i = numberOfSandwiches - 1; i >= 0; i--) {
